...
public class ChangelogInfo {
    ...
    private ReleaseType versionReleaseType;
    ...
    public void parseVersionNumber(String version) {
        ...
        String prereleaseTypeStr = orElse(versionMatcher.group(4), "stable");
        String prereleaseStr = orElse(versionMatcher.group(5), "0");
        ...
        try {
            versionReleaseType = ReleaseType.valueOf(prereleaseTypeStr.toUpperCase());
        } catch (IllegalArgumentException exc) {
            throw new NumberFormatException("Illegal release type: " + versionReleaseType);
        }
        versionPrerelease = Integer.parseUnsignedInt(prereleaseStr);
    }
    ...
    public String getVersionNumber() {
        ...
        if (versionReleaseType != ReleaseType.STABLE) {
            num.append("-");
            num.append(versionReleaseType.name().toLowerCase());
            num.append(".");
            num.append(versionPrerelease);
        }
        return num.toString();
    }
    ...
    public void setVersionPrerelease(int versionPrerelease) {
    ...
    public void setVersionReleaseType(ReleaseType versionReleaseType) {
        this.versionReleaseType = versionReleaseType;
    }

    public ReleaseType getVersionReleaseType() {
    ...
    public static ChangelogInfo parseChangelog(JsonElement element) {
        ...
        if (number.isJsonObject()) {
            ...
            if (hotfix != null) {
                ...
                info.setVersionPrerelease(hotfix.getAsInt());
            }
