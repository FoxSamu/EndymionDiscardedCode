...
import endymion.data.models.stategen.IBlockStateGen;
...
public class EndStateModelProvider implements IDataProvider {
    ...
    public EndStateModelProvider(DataGenerator datagen) {
